...
export default function Rail() {
  ...
  return (
    <div
      aria-hidden="true"
      className="pointer-events-none fixed bottom-[calc(var(--hud-h)+12px)] left-0 top-16 z-30 hidden w-[var(--rail-w)] flex-col items-center gap-4 border-r border-line/30 pt-5 md:flex"
    >
